...
HomCont: class for performing numerical path tracing
HomPath: class for logging homotopy path
...
# %% class for performing numerical path tracing


class HomCont:
    """Class to perform homotopy continuation
