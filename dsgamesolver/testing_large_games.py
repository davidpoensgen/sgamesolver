...
tracing.solver.return_to_step(6800)
tracing.solver.save_file('tracing.json')

tracing.solver.load_file('tracing.json')
...
tracing2 = TracingFixedEta_ct(game)
# tracing2.initialize()
# tracing2.solver.verbose = 2
# tracing2.solver.max_steps = 9000
# sol_tracing2 = tracing2.solver.solve()
