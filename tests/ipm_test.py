...
class TestIPM:
    ...
    initial_strategies = game.random_strategy(zeros=True, seed=23)

    hom = sgamesolver.homotopy.IPM(game, initial_strategies=initial_strategies)
    hom_ct = sgamesolver.homotopy._ipm.IPM_ct(game,initial_strategies=initial_strategies)
